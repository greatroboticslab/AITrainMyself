...
def train_model(data_file_name, epochs, noise):
    ...
    convolved_query = keras.layers.BatchNormalization()(convolved_query)  # Batch normalization
    ...
    dense_layer = keras.layers.Dense(32, kernel_initializer='he_normal', activation='relu',
                                     kernel_regularizer=keras.regularizers.l2(0.001))(flatten_layer)
    ...
    #  Define Callbacks (Early Stopping, LR Scheduler)
